...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    with open(dogfile, "r") as infile:
        ...
        while line != "":
            ...
            if line not in dognames_dic:
                ...
                print(f"** Warning: Duplicate dog name found in file: {line}")
    ...
    for key in results_dic:
        ...
        if results_dic[key][0] in dognames_dic:
            ...
            # TODO: 4c: Append (1,0) to results_dic if pet label is a dog
            #           but classifier label is NOT a dog.
            else:
                results_dic[key].extend((1, 0))

        # Pet Image Label IS NOT a Dog image (e.g. NOT found in dognames_dic)
        else:
            # TODO: 4d: Append (0,1) to results_dic if pet label is NOT a dog
            #           but classifier label is a dog.
            if results_dic[key][1] in dognames_dic:
                results_dic[key].extend((0, 1))

            # TODO: 4e: Append (0,0) to results_dic if neither label is a dog.
            else:
